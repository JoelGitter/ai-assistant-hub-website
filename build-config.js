...
const config = {
    ...
    stripe: {
        ...
        priceIds: {
            ...
            proYearly: '${config.stripe.priceIds.proYearly}'
        }
    },
...
console.log(`✅ Configuration generated for ${environment} environment`);
console.log(`📁 Config file: ${path.join(__dirname, 'config.js')}`);
console.log(`🔑 Stripe Key: ${config.stripe.publishableKey.substring(0, 20)}...`);
console.log(`📊 Analytics ID: ${config.analytics.measurementId}`);
